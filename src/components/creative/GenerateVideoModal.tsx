...
import { CreativeApi, detectImageAspect } from './api'

interface Props {
  productId:    string
  briefingId:   string
  imageId:      string
  /** URL da imagem-base (signed). Quando passada, auto-detecta + trava aspect. */
  imageUrl?:    string | null
  /** Aspect ratio sugerido (default 9:16). É sobrescrito quando imageUrl detecta um aspect. */
...
export default function GenerateVideoModal({
  productId, briefingId, imageId, imageUrl, defaultAspect = '9:16', onClose,
}: Props) {

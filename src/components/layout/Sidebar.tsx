...
const SECTIONS: NavSection[] = [
    ...
    items: [
        ...
        children: [
          ...
          },
          {
            ...
            subItems: [
              ...
              { labelKey: 'items.anunciosTikTok',       href: '/dashboard/catalogo/anuncios/tiktok' },
      ...
      { labelKey: 'items.logistica',  href: '/dashboard/logistica',  icon: <Truck size={15} /> },
      {
        ...
        children: [
          ...
          { labelKey: 'items.financeiroResultado',   href: '/dashboard/financeiro/resultado' },
  ...
  },
  {
    ...
    items: [
      { labelKey: 'items.lojaHub',       href: '/dashboard/loja',           icon: <LayoutDashboard size={15} /> },
      { labelKey: 'items.lojaConfig',    href: '/dashboard/store/config',   icon: <Store size={15} /> },
      { labelKey: 'items.lojaDesigner',  href: '/dashboard/store/designer-v3', icon: <Palette size={15} /> },
      ...
      { labelKey: 'items.lojaBlog',      href: '/dashboard/loja/blog',      icon: <FileText size={15} /> },
      { labelKey: 'items.lojaReviews',   href: '/dashboard/loja/reviews',   icon: <MessageSquare size={15} /> },
      { labelKey: 'items.lojaAnalytics', href: '/dashboard/loja/analytics', icon: <BarChart3 size={15} /> },
      { labelKey: 'items.lojaLeads',     href: '/dashboard/loja/leads',     icon: <Inbox size={15} /> },
      { labelKey: 'items.lojaAmbientador', href: '/dashboard/loja/ambientador', icon: <Sparkles size={15} /> },
      { labelKey: 'items.lojaRecovery',  href: '/dashboard/loja/recovery',  icon: <ShoppingCart size={15} /> },
      { labelKey: 'items.lojaFidelidade', href: '/dashboard/loja/fidelidade', icon: <Trophy size={15} /> },
      { labelKey: 'items.lojaPedidos',   href: '/dashboard/pedidos?platform=storefront', icon: <ShoppingCart size={15} /> },
      { labelKey: 'items.lojaEntregas',  href: '/dashboard/loja/entregas',  icon: <Truck size={15} /> },
      ...
      { labelKey: 'items.lojaAutomacao', href: '/dashboard/automation',     icon: <Zap size={15} /> },
      {
        ...
        children: [
          ...
          { labelKey: 'items.socialShopIgPosts',   href: '/dashboard/social-commerce/instagram/posts' },
...
const ADMIN_SECTION: NavSection = {
  ...
  items: [
    ...
    { labelKey: 'items.adminRoles',    href: '/dashboard/admin/roles', icon: <Shield size={15} /> },

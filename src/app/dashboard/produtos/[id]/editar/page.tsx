...
function dbToForm(p: Record<string, any>): ProductForm {
  ...
  return {
    ...
    taxPercentage:    p.tax_percentage != null ? String(p.tax_percentage) : '',
    taxOnFreight:     p.tax_on_freight ?? false,
    // Shipping
...
export default function EditarProdutoPage() {
  ...
  function buildPayload(status: 'draft' | 'active') {
    return {
      ...
      cost_price:       form.costPrice ? parseFloat(form.costPrice.replace(',', '.')) : null,
      tax_percentage:   form.taxPercentage ? parseFloat(form.taxPercentage.replace(',', '.')) : null,
      tax_on_freight:   form.taxOnFreight,
